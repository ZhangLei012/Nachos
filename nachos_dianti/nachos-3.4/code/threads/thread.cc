...
Thread::Thread(char* threadName)
{
	...
	for(currentThreadNum=0;currentThreadNum<MaxThreadNum;currentThreadNum++){
		if(threadTable.thread[currentThreadNum]==NULL){
			break;
		}
	}
	ASSERT(currentThreadNum<MaxThreadNum);
	threadTable.thread[currentThreadNum]=this;
...
Thread::~Thread()
{
	...
	for(int i=0;i<MaxThreadNum;i++){
		if(threadTable.thread[i]==this){
			threadTable.thread[i]=NULL;
			break;
		}
	}
